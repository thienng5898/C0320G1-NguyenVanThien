...
public class ProvinceController {
    ...
    public ModelAndView listProvinces(){
        ...
        ModelAndView modelAndView = new ModelAndView("customer/province/list");
    ...
    public ModelAndView showEditForm(@PathVariable Long id){
        ...
        if(province != null) {
            ModelAndView modelAndView = new ModelAndView("customer/province/edit");
    ...
    public ModelAndView showDeleteForm(@PathVariable Long id){
        Province province = provinceService.findById(id);
        if(province != null) {
            ModelAndView modelAndView = new ModelAndView("customer/province/delete");
            modelAndView.addObject("province", province);
            return modelAndView;
    ...
    public ModelAndView viewProvince(@PathVariable("id") Long id){
        ...
        ModelAndView modelAndView = new ModelAndView("customer/province/view");
        modelAndView.addObject("province", province);
