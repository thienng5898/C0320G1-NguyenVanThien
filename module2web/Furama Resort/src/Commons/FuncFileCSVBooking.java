...
public class FuncFileCSVBooking {
    ...
    public static void writeBookingToFileCSV(List<Customer> listBooking) {
    ...
    public static List<Customer> getFileCSVToListBooking() {
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                customer.setServices(spilitData[8],spilitData[9],Double.parseDouble(spilitData[10]),Integer.parseInt(spilitData[11]),spilitData[12],Double.valueOf(spilitData[13]));
