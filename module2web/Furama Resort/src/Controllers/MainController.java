...
public class MainController {
    ...
    private void addNewBooking() {
        ...
        List<Customer> listBooking = FuncFileCSVBooking.getFileCSVToListBooking();
        listBooking.add(customer);
        FuncFileCSVBooking.writeBookingToFileCSV(listBooking);
    ...
    private void showInfoEmployee() {
        ...
        List<Employee> employees = ReadCSVEmployee.getFileCSVToListEmployee();
    ...
    public void showAllVillaNotDuplicate() {
        ...
        Set<Villa> villas = new TreeSet<>(FuncFileCSVVilla.getFileCSVToListVilla());
    ...
    public void showAllHouseNotDuplicate() {
        ...
        Set<House> houses = new TreeSet<>(FuncFileCSVHouse.getFileCSVToListHouse());
    ...
    public void showAllRoomNotDuplicate() {
        ...
        Set<Room> rooms = new TreeSet<>(FuncFileCSVRoom.getFileCSVToListRoom());
        for (Room room : rooms) {
            room.showInfo();
        }
        showServices();
    ...
    public void addBooking4dCinema() {
        Scanner sc = new Scanner(System.in);
        List<Customer> listCustomer = FuncFileCSVCustomer.getFileCSVToListCustomer();
        Collections.sort(listCustomer, new SortCustomer());
        for (int i = 0; i < listCustomer.size(); i++) {
            System.out.println("----------------------");
    ...
    public void searchFilingCabinets() {
        ...
        List<Employee> employeeArrayList = ReadCSVEmployee.getFileCSVToListEmployee();
